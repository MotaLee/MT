...
class PiIIC(object):
        ...
        try:
            with open('/proc/cpuinfo', 'r') as infile:
                for line in infile:
                    ...
                    if match and match.group(1) in ['0000', '0002', '0003']:return 1
                    elif match:return 2
                    return 0
    ...
    def getPiI2CBusNumber():
        ...
        return 1 if PiIIC.getPiRevision() > 1 else 0
    ...
    def __init__(self, addr, busnum=-1, debug=False):
        ...
        # self.bus = smbus.SMBus(busnum if busnum >= 0 else PiIIC.getPiI2CBusNumber())
        self.debug = debug
    ...
    def write16(self, reg, value):
        ...
        try:
            ...
            if self.debug:
                ...
                (value, reg, reg+1))
        except IOError:return self.errMsg()
    ...
    def writeList(self, reg, list):
        ...
        try:
            if self.debug:
                ...
                print(list)
            self.bus.write_i2c_block_data(self.addr, reg, list)
        except IOError:return self.errMsg()
